...
/**
 * Custom effect cho Crab Summon.
 * Sand vortex effect với crab shell reveal pattern.
 */
public class CrabSummonEffect {
    ...
    public static void init() {
        LOGGER.debug("CrabSummonEffect initialized");
    }
    ...
    public static void activate(double x, double y, double z) {
        ...
        active = true;
        LOGGER.debug("CrabSummonEffect activated at ({}, {}, {})", x, y, z);
    }
    ...
    public static void render() {
        ...
        if (progress >= 1.0f) {
            active = false;
            LOGGER.debug("CrabSummonEffect completed");
        }
    }
