...
/**
 * Custom effect cho Time Bomb (Zilean).
 * Fire explosion effect với noise crack và pulsing ring.
 */
public class TimeBombEffect {
    ...
    public static void init() {
        LOGGER.debug("TimeBombEffect initialized");
    }
    ...
    public static void activate(double x, double y, double z) {
        ...
        active = true;
        LOGGER.debug("TimeBombEffect activated at ({}, {}, {})", x, y, z);
    }
    ...
    public static void render() {
        ...
        if (progress >= 1.0f) {
            active = false;
            LOGGER.debug("TimeBombEffect completed");
        }
    }
