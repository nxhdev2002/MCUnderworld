...
/**
 * Custom effect cho Void Spawn (Tryndamere).
 * Dark rift effect với purple energy core.
 */
public class VoidSpawnEffect {
    ...
    public static void init() {
        LOGGER.debug("VoidSpawnEffect initialized");
    }
    ...
    public static void activate(double x, double y, double z) {
        ...
        active = true;
        LOGGER.debug("VoidSpawnEffect activated at ({}, {}, {})", x, y, z);
    }
    ...
    public static void render() {
        ...
        if (progress >= 1.0f) {
            active = false;
            LOGGER.debug("VoidSpawnEffect completed");
        }
    }
