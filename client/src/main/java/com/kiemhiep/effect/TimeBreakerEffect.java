...
/**
 * Custom effect cho Time Breaker (Ekko).
 * Time warp effect với blue streak và time distortion.
 */
public class TimeBreakerEffect {
    ...
    public static void init() {
        LOGGER.debug("TimeBreakerEffect initialized");
    }
    ...
    public static void activate(double x, double y, double z) {
        ...
        active = true;
        LOGGER.debug("TimeBreakerEffect activated at ({}, {}, {})", x, y, z);
    }
    ...
    public static void render() {
        ...
        if (progress >= 1.0f) {
            active = false;
            LOGGER.debug("TimeBreakerEffect completed");
        }
    }
