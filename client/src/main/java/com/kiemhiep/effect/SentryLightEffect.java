...
/**
 * Custom effect cho Sentry Light (Vikor).
 * Light flare effect với pulsing và rotating rings.
 */
public class SentryLightEffect {
    ...
    public static void init() {
        LOGGER.debug("SentryLightEffect initialized");
    }
    ...
    public static void activate(double x, double y, double z) {
        ...
        active = true;
        LOGGER.debug("SentryLightEffect activated at ({}, {}, {})", x, y, z);
    }
    ...
    public static void render() {
        ...
        if (progress >= 1.0f) {
            active = false;
            LOGGER.debug("SentryLightEffect completed");
        }
    }
