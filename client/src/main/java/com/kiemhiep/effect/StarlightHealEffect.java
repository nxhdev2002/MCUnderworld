...
/**
 * Custom effect cho Starlight Heal (Soraka).
 * Ice crystal shimmer effect với healing ring pattern.
 */
public class StarlightHealEffect {
    ...
    public static void init() {
        LOGGER.debug("StarlightHealEffect initialized");
    }
    ...
    public static void activate(double x, double y, double z) {
        ...
        active = true;
        LOGGER.debug("StarlightHealEffect activated at ({}, {}, {})", x, y, z);
    }
    ...
    public static void render() {
        ...
        if (progress >= 1.0f) {
            active = false;
            LOGGER.debug("StarlightHealEffect completed");
        }
    }
