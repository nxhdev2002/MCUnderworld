...
/**
 * Custom effect cho Frozen Cage.
 * Ice cage effect với frost spread.
 */
public class FrozenCageEffect {
    ...
    public static void init() {
        LOGGER.debug("FrozenCageEffect initialized");
    }
    ...
    public static void activate(double x, double y, double z) {
        ...
        active = true;
        LOGGER.debug("FrozenCageEffect activated at ({}, {}, {})", x, y, z);
    }
    ...
    public static void render() {
        ...
        if (progress >= 1.0f) {
            active = false;
            LOGGER.debug("FrozenCageEffect completed");
        }
    }
