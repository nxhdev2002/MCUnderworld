...
/**
 * Custom effect cho Light Spike (Lux).
 * Light spear effect dengan glowing trail.
 */
public class LightSpikeEffect {
    ...
    private static final int DURATION_MS = 4500;

    public static void init() {
        LOGGER.debug("LightSpikeEffect initialized");
    }
    ...
    public static void activate(double x, double y, double z) {
        ...
        active = true;
        LOGGER.debug("LightSpikeEffect activated at ({}, {}, {})", x, y, z);
    }
    ...
    public static void render() {
        ...
        if (progress >= 1.0f) {
            active = false;
            LOGGER.debug("LightSpikeEffect completed");
        }
    }
