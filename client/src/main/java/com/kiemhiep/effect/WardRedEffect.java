...
/**
 * Custom effect cho Ward Red.
 * Flame sentinel effect với rotating orange ring.
 */
public class WardRedEffect {
    ...
    public static void init() {
        LOGGER.debug("WardRedEffect initialized");
    }
    ...
    public static void activate(double x, double y, double z) {
        ...
        active = true;
        LOGGER.debug("WardRedEffect activated at ({}, {}, {})", x, y, z);
    }
    ...
    public static void render() {
        ...
        if (progress >= 1.0f) {
            active = false;
            LOGGER.debug("WardRedEffect completed");
        }
    }
