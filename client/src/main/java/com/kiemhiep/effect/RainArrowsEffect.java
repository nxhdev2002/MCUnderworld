...
/**
 * Custom effect cho Rain Arrows (Miss Fortune).
 * Arrow rainfall effect với impact rings.
 */
public class RainArrowsEffect {
    ...
    public static void init() {
        LOGGER.debug("RainArrowsEffect initialized");
    }
    ...
    public static void activate(double x, double y, double z) {
        ...
        active = true;
        LOGGER.debug("RainArrowsEffect activated at ({}, {}, {})", x, y, z);
    }
    ...
    public static void render() {
        ...
        if (progress >= 1.0f) {
            active = false;
            LOGGER.debug("RainArrowsEffect completed");
        }
    }
