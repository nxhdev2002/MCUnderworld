...
/**
 * Custom effect cho Ward Blue.
 * Water crystal forming effect với blue shimmer.
 */
public class WardBlueEffect {
    ...
    public static void init() {
        LOGGER.debug("WardBlueEffect initialized");
    }
    ...
    public static void activate(double x, double y, double z) {
        ...
        active = true;
        LOGGER.debug("WardBlueEffect activated at ({}, {}, {})", x, y, z);
    }
    ...
    public static void render() {
        ...
        if (progress >= 1.0f) {
            active = false;
            LOGGER.debug("WardBlueEffect completed");
        }
    }
