...
/**
 * Custom effect cho Beast Wolf (Brand).
 * Fire claw slash effect với orange-red gradient.
 */
public class BeastWolfEffect {
    ...
    public static void init() {
        LOGGER.debug("BeastWolfEffect initialized");
    }
    ...
    public static void activate(double x, double y, double z) {
        ...
        active = true;
        LOGGER.debug("BeastWolfEffect activated at ({}, {}, {})", x, y, z);
    }
    ...
    public static void render() {
        ...
        if (progress >= 1.0f) {
            active = false;
            LOGGER.debug("BeastWolfEffect completed");
        }
    }
