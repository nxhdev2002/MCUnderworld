...
/**
 * Custom effect cho Phoenix Flame.
 * Wing spread effect với fire vortex và glowing core.
 */
public class PhoenixFlameEffect {
    ...
    public static void init() {
        LOGGER.debug("PhoenixFlameEffect initialized");
    }
    ...
    public static void activate(double x, double y, double z) {
        ...
        active = true;
        LOGGER.debug("PhoenixFlameEffect activated at ({}, {}, {})", x, y, z);
    }
    ...
    public static void render() {
        ...
        if (progress >= 1.0f) {
            active = false;
            LOGGER.debug("PhoenixFlameEffect completed");
        }
    }
