...
/**
 * Custom effect cho Quantum Ray.
 * Electric beam effect với neon glow và piercing light.
 */
public class QuantumRayEffect {
    ...
    public static void init() {
        LOGGER.debug("QuantumRayEffect initialized");
    }
    ...
    public static void activate(double x, double y, double z) {
        ...
        active = true;
        LOGGER.debug("QuantumRayEffect activated at ({}, {}, {})", x, y, z);
    }
    ...
    public static void render() {
        ...
        if (progress >= 1.0f) {
            active = false;
            LOGGER.debug("QuantumRayEffect completed");
        }
    }
