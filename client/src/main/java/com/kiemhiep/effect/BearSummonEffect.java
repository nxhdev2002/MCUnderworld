...
/**
 * Custom effect cho Bear Summon.
 * Earth pillars effect với spirit pattern.
 */
public class BearSummonEffect {
    ...
    public static void init() {
        LOGGER.debug("BearSummonEffect initialized");
    }
    ...
    public static void activate(double x, double y, double z) {
        ...
        active = true;
        LOGGER.debug("BearSummonEffect activated at ({}, {}, {})", x, y, z);
    }
    ...
    public static void render() {
        ...
        if (progress >= 1.0f) {
            active = false;
            LOGGER.debug("BearSummonEffect completed");
        }
    }
