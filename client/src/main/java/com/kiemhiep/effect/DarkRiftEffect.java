...
/**
 * Custom effect cho Dark Rift.
 * Void pull effect với purple particles và distortion.
 */
public class DarkRiftEffect {
    ...
    public static void init() {
        LOGGER.debug("DarkRiftEffect initialized");
    }
    ...
    public static void activate(double x, double y, double z) {
        ...
        active = true;
        LOGGER.debug("DarkRiftEffect activated at ({}, {}, {})", x, y, z);
    }
    ...
    public static void render() {
        ...
        if (progress >= 1.0f) {
            active = false;
            LOGGER.debug("DarkRiftEffect completed");
        }
    }
